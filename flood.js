...
function load_flood(error, array) {
/*
 ...
 */
	...
	for (let index in array) {
		draw_flood(array[index], index);
	}
}

function draw_flood(dataArray, index) {
/*
...
*/
	...
	// Draw canvas
	drawCanvasFlood(dataContainer, context, canvas);
}

function drawCanvasFlood(dataContainer, context, canvas) {
/*
