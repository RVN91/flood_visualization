// https://raw.githubusercontent.com/RVN91/personal_webpage/master/rain_gauge_intensity.csv
...
var svg_rainfall = d3.select("#rainfall")
  .append("svg")
...
d3.csv("https://raw.githubusercontent.com/RVN91/personal_webpage/master/rain_gauge_intensity.csv",
	...
	function(data) {
		...
		/* // Add the line
		let line_index = 0
		var lines = svg_rainfall.append("path")
			.datum(data)
			...
			.attr("d", d3.line()
				...
				.y(function(d) { return y(d.intensity_gauge_1) })
				); */
		// Lines
		let line_index = 0
